public class Luxury_car extends Super_car{
    ...
    public Luxury_car(int pricebuy,int pricesell,float weight,float length,float height,float width,String Companycar,String interior_material,String sound_system, String climate_control,String safety_features)
    {
    ...
    {
        super(lc.getPricebuy(),lc.getPricesell(),lc.getWeight(),lc.getLength(),lc.getHeight(),lc.getWidth(),lc.getCompanyCar());
